"""
Configuration for the Python Git Change Log package.
...
section_regexps = [
    ...
    ('Other', None  # Match all lines that don't fit above
     )
]
...
subject_process = (
    ...
    ReSub(
        r'^('
        r'(feat|fix|new|chg|build|chore|ci|docs|perf|refactor|style|test)'
        r'(\([^)]+\))?!?'
        r')\s*:\s*'
        r'((dev|use?r|pkg|test|doc)\s*:\s*)?'
        r'([^\n@]*)'
        r'(@[a-z]+\s+)*$',
        r'\6'
    ) |
